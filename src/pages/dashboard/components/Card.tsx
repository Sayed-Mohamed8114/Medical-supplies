  ...
  return (
    <Card size="sm" className="relative mx-auto w-full max-w-sm bg-white px-4!">
      <CardContent className="py-3!">
        <div
          className={`absolute top-5 right-5 w-10 h-10 rounded-[8px]  flex items-center justify-center ${background}`}
        >
          <img src={src} className="w-3.75 h-3.75 text-white" alt={title} />
        </div>
